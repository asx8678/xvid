...
export const PRIVACY_POLICY_URL = "options/privacy.html";

// --- Warning strings ---
export const AUTH_API_WARNING = "Your X account was used to fetch this video. Enable Syndication-only mode in Settings to stay anonymous.";
